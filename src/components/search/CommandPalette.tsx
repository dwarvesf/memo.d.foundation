...
const CommandPalette: React.FC = () => {
  ...
  const handleArrowDown = useCallback(() => {
    if (query && results.flat.length > 0) {
      ...
      const currentIndex = results.flat.findIndex(
  ...
  const handleArrowUp = useCallback(() => {
    if (query && results.flat.length > 0) {
      ...
      const prevIndex =
        currentIndex <= 0 ? results.flat.length - 1 : currentIndex - 1;
        ...
        <div className="cmd-results-list-wrapper">
          ...
          {selectedItem && (
            <div className="cmd-result-preview">
              ...
              <p className="cmd-preview-description">
      ...
      <>
              ...
              {recentPages.map((page, index) => (
                ...
                >
                  ...
                  <div className="cmd-idle-item-text">
                    ...
                    <span className="cmd-idle-item-subtitle">
                      {page.path
                        .split('/')
                        .filter(p => p)
                        .join(' > ')}
        ...
        <div className="cmd-idle-section">
          <div className="cmd-idle-header">
            <span className="cmd-idle-group-title">
          ...
          <ul className="cmd-idle-list">
            ...
            >
              ...
              <div className="cmd-idle-item-text">
                <span className="cmd-idle-item-title">
  ...
  return (
    <div className="cmd-palette">
      ...
      <button
        className="cmd-search-button-mobile"
      ...
      {isOpen && (
        <div className="cmd-overlay cmd-modal-active" ref={searchContainerRef}>
          ...
          >
            ...
            <div
              className={`cmd-results ${isOpen ? 'cmd-results-active' : 'cmd-results-hidden'}`}
            >
              {renderSearchResults()}
              {renderIdleSections()}
