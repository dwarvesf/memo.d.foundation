  ...
  return (
    <>
      ...
      {isOpen &&
        ...
        createPortal(
          <div
            className="fixed inset-0 z-[9999] flex items-center justify-center p-4 md:pt-[min(8vh,6rem)]"
            style={{
              background:
          ...
          >
            <div
              ...
              className="dark:bg-background w-full max-w-[720px] overflow-hidden rounded-[8px] border border-[var(--border)] shadow-lg backdrop-blur-xl"
              style={{
            ...
            >
              <div
                ...
                style={{ padding: '12px 16px', height: 48 }}
              >
                <div
                  style={{
                    position: 'absolute',
                            ...
                            {categoryResults.map((result, index) => {
                              ...
                              return (
                                <button
                                  ...
                                  className={cn(
                                    'command-palette-modal-result border-border group flex w-full flex-col border-b px-3 py-2.5 text-left text-sm last:border-b-0',
                                    {
                                      selected: isSelected,
                                    },
                                  )}
              ...
              <div
                className="text-muted-foreground relative flex justify-between border-t border-[var(--border)] p-2 text-xs"
                style={{ height: 37 }}
              >
                <div
                  style={{
                ...
                <div className="flex space-x-4">
                  ...
                  <div className="flex items-center">
                    <kbd className="mr-1 flex items-center justify-center rounded-md bg-[var(--border)] px-1 py-0.5 font-sans text-[12px] leading-4 font-medium text-[var(--muted-foreground)]">
                      ↵
                    </kbd>
                    to select
                  </div>
