...
- `cd lib/obsidian-compiler && mix export_markdown`: convert the `vault/` submodule to standardized markdown + `public/content/`. **Still the production markdown step** (see "Content compilers" below), not yet replaced.
