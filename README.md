...
The app uses client-side search with MiniSearch. Search is lexical, not semantic. To improve build performance and reduce page size, we generate a separate search index file during the build process:
