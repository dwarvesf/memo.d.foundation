...
_`SpiderMonkey JavaScript` follows the same approach but it uses the `Cranelift` baseline compiler for `WebAssembly`_. You can follow [this document]() to see how Cranelift fits in the SpiderMonkey engine.
